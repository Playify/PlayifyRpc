(()=>{
	const Rpc:typeof import("../rpc.js").Rpc=(globalThis as any).Rpc;
	const RpcSymbols:typeof import("../rpc.js").RpcSymbols=(globalThis as any).RpcSymbols;
	type RpcError=import("../rpc.js").RpcError;
